    ...
    <section className="relative overflow-hidden pt-3 pb-10 sm:py-14 lg:py-20">
      <div className="grid items-center gap-10 md:grid-cols-[1.15fr_1fr]">
        <div className="flex max-w-2xl flex-col gap-6">
          <p className="font-mono font-semibold tracking-[0.22em] text-[var(--fs-eyebrow)] text-primary uppercase">
          ...
          <div className="flex flex-wrap gap-4 pt-1">
            ...
            <ActionLink href="/developer" className="h-11 px-[26px] text-base">
              <IconPencil />
              Contribute
            </ActionLink>
          </div>
