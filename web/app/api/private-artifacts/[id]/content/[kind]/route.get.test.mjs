...
// Take the kind table, media types, limits and redirect set from the real
// module rather than restating them: hand-written copies here would not have
// included manifest_toml/bundle_zip, so GET would have been asserted against
// a kind table the production code no longer has.
const {
  CONTENT_MEDIA_TYPES,
