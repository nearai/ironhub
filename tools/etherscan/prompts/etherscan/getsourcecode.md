...
Run the legacy getsourcecode operation. See the prompt and input schema for its exact contract.
...
The operation is selected by IronClaw as `etherscan.getsourcecode`. Do not send the private `action` selector.
